            ...
            <div class="container-form">
                ...
                <form action="inforregister" method="POST">
                    <div class="form-group form-general">
                        ...
                        <input type="text" class="form-control infor-register" value="${student.firstName}" name="firstName">
                    </div>
                    <div class="form-group form-general">
                        <label>Last Name</label>
                        <input type="text" class="form-control infor-register" value="${student.lastName}" name="lastName">
                    </div>
                    <div class="form-group form-general">
                        <label>Date Of Birth</label>
                        <input type="date" class="form-control infor-register" value="${student.dob}" name="dob">
                    </div>
                    <div class="form-group form-general">
                        <label>Gender</label>
                        <div>
                        ...
                        <div class="form-group form-general">
                            <label>Address</label>
                            <input type="text" class="form-control infor-register" value="${student.address}" name="address">
                    </div>
                    <div class="form-group form-general">
                        <label>Phone number</label>
                        <input type="text" class="form-control infor-register" value="${student.phoneNumber}" name="phoneNumber">
                    </div>
                    <div class="form-group form-general">
                        <label>Email</label>
                        <input type="email" class="form-control infor-register" value="${student.email}" name="email">
                    </div>
                    <div class="form-group form-general">
                        <label>Specialized</label>
                        <select class="form-control infor-register" name="specialized">
                        ...
                        <div class="form-group form-general">
                            ...
                            <input type="text" class="form-control infor-register"  name="membercode" value="${nameStudent}${specialized}${student.id}">
                        </div>
                        <div class="form-group form-general">
